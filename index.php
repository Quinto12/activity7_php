...
if(isset($_GET['logout']) && $_GET['logout'] == true){
    $message="";
        ...
        if($email == "quinto.royvineth@mscmarinduque.edu.ph" && $password == "1234"){
        ...
        echo "<script>window.location.href = 'pages/dashboard.php'</script>";
            ...
            $message = "<div class='alert alert-danger'>Please enter your Email or Passowrd</div>";
        // echo "<script>alert('Login Failed');</script>";
        }else{
            $message = "<div class='alert alert-danger'>Loggin Failed!!</div>";
        }
}
?>
